...
namespace App\Platform\Filament\Resources\Users;
...
use App\Platform\Filament\Resources\Users\Pages\ListUsers;
use App\Models\User;
use BackedEnum;
...
class UserResource extends Resource
{
        ...
        return $schema->components([
            ...
            Select::make('role_names')
                ...
                ->options(fn (): array => Role::query()
                    ->where('client_id', app(CurrentClient::class)->id())
                    ->orderBy('name')
                    ->pluck('name', 'name')
                    ->all())
                ->dehydrated(false),
    ...
    private static function canManageUsers(): bool
    {
        ...
        return $user instanceof User
            && ($user->can('platform.users.manage') || $user->can('users.manage') || $user->hasAnyRole(['admin', 'bdo']));
    }
}
