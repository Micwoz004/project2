...
enum SystemPermission: string
{
    ...
    case EcoUslugiAdminAccess = 'eco_uslugi.admin.access';
    case EcoUslugiZonesManage = 'eco_uslugi.zones.manage';
    case EcoUslugiWasteManage = 'eco_uslugi.waste.manage';
    case EcoUslugiSchedulesManage = 'eco_uslugi.schedules.manage';
    case EcoUslugiPszokManage = 'eco_uslugi.pszok.manage';
    case EcoUslugiNewsManage = 'eco_uslugi.news.manage';
    case EcoUslugiNotificationsManage = 'eco_uslugi.notifications.manage';
    case EcoUslugiAirQualityManage = 'eco_uslugi.air_quality.manage';
