...
enum SystemPermission: string
{
    ...
    case EkoUslugiAdminAccess = 'eko_uslugi.admin.access';
    case EkoUslugiZonesManage = 'eko_uslugi.zones.manage';
    case EkoUslugiWasteManage = 'eko_uslugi.waste.manage';
    case EkoUslugiSchedulesManage = 'eko_uslugi.schedules.manage';
    case EkoUslugiPszokManage = 'eko_uslugi.pszok.manage';
    case EkoUslugiNewsManage = 'eko_uslugi.news.manage';
    case EkoUslugiNotificationsManage = 'eko_uslugi.notifications.manage';
    case EkoUslugiAirQualityManage = 'eko_uslugi.air_quality.manage';
