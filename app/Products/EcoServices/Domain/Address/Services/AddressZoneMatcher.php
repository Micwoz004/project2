...
use App\Products\EcoServices\Domain\Address\Models\EcoZoneAddressRule;
...
class AddressZoneMatcher
{
    ...
    {
        Log::info('eco_services.address.zone_match.start', [
        ...
        Log::info('eco_services.address.zone_match.success', [
            'resident_address_id' => $address->id,
            'eco_zone_id' => $zone?->id,
        ]);
