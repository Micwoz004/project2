...
namespace App\Products\EcoServices\Domain\AirQuality\Actions;
...
use App\Products\EcoServices\Domain\AirQuality\Services\GiosAirQualityClient;
...
class SyncAirQualityStationsAction
{
    ...
    {
        Log::info('eco_services.air_quality.sync.start');
        ...
        Log::info('eco_services.air_quality.sync.success', [
