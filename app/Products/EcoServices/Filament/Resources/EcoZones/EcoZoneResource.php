...
namespace App\Products\EcoServices\Filament\Resources\EcoZones;

use App\Products\EcoServices\Domain\Address\Models\EcoZone;
use App\Products\EcoServices\Filament\Resources\EcoZones\Pages\CreateEcoZone;
use App\Products\EcoServices\Filament\Resources\EcoZones\Pages\EditEcoZone;
use App\Products\EcoServices\Filament\Resources\EcoZones\Pages\ListEcoZones;
use BackedEnum;
...
class EcoZoneResource extends Resource
{
    protected static ?string $model = EcoZone::class;
    ...
    {
        return [
            'index' => ListEcoZones::route('/'),
            'create' => CreateEcoZone::route('/create'),
            'edit' => EditEcoZone::route('/{record}/edit'),
        ];
    }
}
