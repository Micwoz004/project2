...
namespace App\Products\EcoUslugi\Domain\Notifications\Actions;
...
class QueueCollectionReminderNotificationsAction
{
    ...
    {
        Log::info('eco_uslugi.notifications.collection_reminders.start');
        ...
        Log::info('eco_uslugi.notifications.collection_reminders.success', [
            'events' => $events,
        ]);
