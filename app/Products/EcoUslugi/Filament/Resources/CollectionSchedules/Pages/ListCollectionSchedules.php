...
namespace App\Products\EcoUslugi\Filament\Resources\CollectionSchedules\Pages;

use App\Products\EcoUslugi\Domain\Schedule\Actions\ImportCollectionScheduleCsvAction;
use App\Products\EcoUslugi\Filament\Resources\CollectionSchedules\CollectionScheduleResource;
            ...
            Action::make('importScheduleCsv')
                ...
                ->schema([
                    FileUpload::make('file')
                        ->label('Plik CSV')
                        ->disk('local')
                        ->directory('eco-uslugi/schedule-imports')
