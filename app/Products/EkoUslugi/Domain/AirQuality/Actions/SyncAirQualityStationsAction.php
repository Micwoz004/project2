...
namespace App\Products\EkoUslugi\Domain\AirQuality\Actions;
...
use App\Products\EkoUslugi\Domain\AirQuality\Services\GiosAirQualityClient;
...
class SyncAirQualityStationsAction
{
    ...
    {
        Log::info('eko_uslugi.air_quality.sync.start');
        ...
        Log::info('eko_uslugi.air_quality.sync.success', [
    ...
    private function syncIndexReading(AirQualityStation $station, string $externalId): int
    {
        ...
        AirQualityReading::query()->updateOrCreate(
            [
                'eko_air_quality_station_id' => $station->id,
                'parameter_code' => 'AQI',
