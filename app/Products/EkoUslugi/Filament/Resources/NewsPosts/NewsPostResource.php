...
namespace App\Products\EkoUslugi\Filament\Resources\NewsPosts;

use App\Products\EkoUslugi\Domain\Address\Models\EkoZone;
use App\Products\EkoUslugi\Domain\News\Models\NewsCategory;
use App\Products\EkoUslugi\Domain\News\Models\NewsPost;
use App\Products\EkoUslugi\Filament\Resources\NewsPosts\Pages\CreateNewsPost;
use App\Products\EkoUslugi\Filament\Resources\NewsPosts\Pages\EditNewsPost;
use App\Products\EkoUslugi\Filament\Resources\NewsPosts\Pages\ListNewsPosts;
use BackedEnum;
...
class NewsPostResource extends Resource
{
    ...
    protected static string|UnitEnum|null $navigationGroup = 'Eko usługi - aktualności';
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            ...
            Select::make('eko_news_category_id')
                ->label('Kategoria')
            ...
            Select::make('eko_zone_id')
                ->label('Strefa')
                ->options(fn (): array => EkoZone::query()->orderBy('name')->pluck('name', 'id')->all())
                ->searchable(),
