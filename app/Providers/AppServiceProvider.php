...
use App\Policies\CostGuideItemPolicy;
use App\Policies\DepartmentPolicy;
use App\Policies\DictionaryEntryPolicy;
use App\Policies\ProjectAppealPolicy;
...
use App\Products\EkoUslugi\Domain\Waste\Services\GeminiWasteRecognitionClient;
use App\Products\EkoUslugi\Domain\Waste\Services\WasteRecognitionClient;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(CostGuideItem::class, CostGuideItemPolicy::class);
