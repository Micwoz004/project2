...
<body style="margin:0; padding:0; background:#f5f5f2; color:#262626; font-family:'Source Sans 3','Segoe UI',Arial,sans-serif;">
    <div style="display:none; max-height:0; overflow:hidden; opacity:0; color:transparent;">Potwierdź adres e-mail w serwisie Budżet Obywatelski</div>
                ...
                <table role="presentation" class="email-wrap" width="640" cellspacing="0" cellpadding="0" style="width:640px; max-width:640px; background:#ffffff; border-collapse:separate; border-spacing:0; border-radius:26px 26px 0 0; overflow:hidden; box-shadow:0 20px 70px rgba(38,38,38,.12);">
                                ...
                                <tr>
                                    <td style="height:138px; background-color:#262626; background-image:linear-gradient(90deg, rgba(22,142,69,.94), rgba(244,198,0,.82));">
                                        <div style="padding:26px 28px; color:#fff;">
                                            ...
                                            <div style="margin-top:12px; font-family:'Barlow Condensed','Arial Narrow',Arial,sans-serif; font-size:36px; line-height:1; font-weight:800;">Potwierdzenie e-mail</div>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td class="email-pad" style="padding:36px 46px 16px;">
                            ...
                            <p style="margin:20px 0 0; font-size:18px; line-height:1.58; color:#262626;">Dzień dobry{{ filled($residentName) ? ', '.$residentName : '' }}. Kliknij przycisk poniżej, aby potwierdzić adres {{ $residentEmail }} w serwisie {{ $cityName }}.</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="email-pad" style="padding:8px 46px 42px;">
                            <a class="email-button" href="{{ $verificationUrl }}" style="display:inline-block; padding:15px 22px; border-radius:10px; background:#168e45; color:#ffffff; font-size:16px; font-weight:800; text-decoration:none;">Potwierdź adres e-mail</a>
                            <p style="margin:22px 0 0; font-size:14px; line-height:1.55; color:#60605d;">Jeśli nie zakładano konta w serwisie Budżetu Obywatelskiego, tę wiadomość można zignorować.</p>
                        </td>
                    </tr>
                </table>
