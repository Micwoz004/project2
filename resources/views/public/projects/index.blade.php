<x-public.layout title="Projekty SBO">
    <section class="page-hero">
        <div>
            <h1 class="page-title">Projekty SBO Szczecin</h1>
            <p class="page-summary">Przeglądaj projekty, filtruj po edycji, obszarze i kategorii oraz sprawdzaj status publiczny każdego zgłoszenia.</p>
        </div>
        <div class="actions">
